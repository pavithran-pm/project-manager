...
import { comingSoon, findFolder, findListItem, useAppStore } from '../../lib/store'
      ...
      <div className="flex h-12 items-center gap-1 border-b border-line px-4">
        ...
        {listItem && (
          <>
            ...
            <button
              onClick={soon('The list settings menu')}
              className="flex cursor-pointer items-center gap-1.5 rounded-md px-1.5 py-1 hover:bg-hover"
            >
        ...
        <div className="ml-auto flex items-center gap-1">
          <button
            onClick={soon('Meetings')}
            className="flex h-7 cursor-pointer items-center gap-0.5 rounded-md px-1.5 hover:bg-hover"
          >
            <Video className="h-4 w-4 text-ink-soft" />
            <ChevronDown className="h-3 w-3 text-ink-faint" />
          </button>
          <button
            onClick={soon('Automations')}
